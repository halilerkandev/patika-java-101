...
public class Main {
    public static void main(String[] args) {
        ...
        boolean dordunKati = yil % 4 == 0;
        boolean yuzunKati = yil % 100 == 0;
        boolean dortYuzunKati = yil % 400 == 0;

        boolean artikYil = dortYuzunKati || (!yuzunKati && dordunKati);
        String aciklama = yil + " bir artık yıl" + (artikYil ? "dır !" : " değildir !");
